...
var style_IndicedeVegetacion_4 = function(feature, resolution){
    ...
    if (value >= 0.191349 && value <= 0.264337) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.264337 && value <= 0.337326) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.337326 && value <= 0.410314) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.410314 && value <= 0.483303) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.483303 && value <= 0.556291) {
            style = [ new ol.style.Style({
