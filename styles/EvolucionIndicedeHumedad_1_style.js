...
var style_EvolucionIndicedeHumedad_1 = function(feature, resolution){
    ...
    if (value >= -0.124784 && value <= -0.065458) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.065458 && value <= -0.006133) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.006133 && value <= 0.053193) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.053193 && value <= 0.112519) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.112519 && value <= 0.171845) {
            style = [ new ol.style.Style({
