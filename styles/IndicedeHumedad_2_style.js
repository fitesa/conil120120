...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.296288 && value <= -0.219439) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.219439 && value <= -0.142590) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.142590 && value <= -0.065741) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.065741 && value <= 0.011108) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.011108 && value <= 0.087958) {
            style = [ new ol.style.Style({
